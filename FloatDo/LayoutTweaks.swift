...
final class LayoutTweaks: ObservableObject, @unchecked Sendable {
    ...
    private enum Keys {
        static let panelCornerRadius = "floatdo.layout.panelCornerRadius"
        static let handleCornerRadius = "floatdo.layout.handleCornerRadius"
        static let collapsedWidth = "floatdo.layout.collapsedWidth"
        static let collapsedHeight = "floatdo.layout.collapsedHeight"
        static let expandedWidth = "floatdo.layout.expandedWidth"
        static let expandedHeight = "floatdo.layout.expandedHeight"
        static let edgeInset = "floatdo.layout.edgeInset"

        static let contentHorizontalPadding = "floatdo.layout.contentHorizontalPadding"
        static let contentTopPadding = "floatdo.layout.contentTopPadding"
        static let contentBottomPadding = "floatdo.layout.contentBottomPadding"
        static let rowSpacing = "floatdo.layout.rowSpacing"

        static let inputCornerRadius = "floatdo.layout.inputCornerRadius"
        static let inputLeadingPadding = "floatdo.layout.inputLeadingPadding"
        static let inputTrailingPadding = "floatdo.layout.inputTrailingPadding"
        static let inputVerticalPadding = "floatdo.layout.inputVerticalPadding"

        static let rowCornerRadius = "floatdo.layout.rowCornerRadius"
        static let rowHorizontalPadding = "floatdo.layout.rowHorizontalPadding"
        static let rowVerticalPadding = "floatdo.layout.rowVerticalPadding"
        static let rowInnerSpacing = "floatdo.layout.rowInnerSpacing"

        static let bodyTextSize = "floatdo.layout.bodyTextSize"
        static let secondaryTextSize = "floatdo.layout.secondaryTextSize"
        static let checkboxSize = "floatdo.layout.checkboxSize"
        static let actionIconSize = "floatdo.layout.actionIconSize"
        static let listIconSize = "floatdo.layout.listIconSize"

        static let pillCornerRadius = "floatdo.layout.pillCornerRadius"
        static let pillHorizontalPadding = "floatdo.layout.pillHorizontalPadding"
        static let pillVerticalPadding = "floatdo.layout.pillVerticalPadding"
        static let pillSpacing = "floatdo.layout.pillSpacing"

        static let checkmarkSize = "floatdo.layout.checkmarkSize"
        static let addListIconSize = "floatdo.layout.addListIconSize"
    }
